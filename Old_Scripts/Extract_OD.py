...
# Load the data
data = pd.read_csv('/mnt/g/Shared drives/Arcaea Shared Drive/Personal Folders/Feranmi/Experimental Data/Buffered_Spray_AAs_SLM_09_14_23_R3_FA.csv', header=None)
output_path = "/mnt/g/Shared drives/Arcaea Shared Drive/Personal Folders/Feranmi/Experimental Data/Test_v1_ExtractOD_output_file.csv"  # Change this path to your desired location and filename
